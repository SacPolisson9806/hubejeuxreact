...
import QuestManager from "./quetes/quetesmanager";
...
export default function Profil() {
  ...
  useEffect(() => {
    ...
    if (!storedName) navigate("/hubjeux");
    else setPlayerName(storedName);

    // Récupère la XP totale du joueur depuis QuestManager
    const xp = QuestManager.getPlayerXP(storedName);
    setPlayerXP(xp);

    // Calcul automatique du niveau selon XP
  ...
  return (
    <div className="profil-page">
      <style>{`
        ...
        .profil-page { height:100vh; display:flex; flex-direction:column; justify-content:center; align-items:center; color:white; }
